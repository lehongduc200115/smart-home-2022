...
const HomePage = () => {
  return (
    <div>
      <div className="bd1">
        <div className="list">
          <a style={{ float: "left", marginLeft: "60vw" }} href="homepage">
            <h1 className="font2 font3">HOME</h1>
          </a>
          <a style={{ float: "left", marginLeft: "3vw" }} href="#">
            <h1 className="font2 font3">ABOUT US</h1>
          </a>
          <a style={{ float: "left", marginLeft: "4vw" }} href="#">
            <h1 className="font2 font3">DASHBOARD</h1>
          </a>
          <a style={{ float: "left", marginLeft: "5.5vw" }} href="login">
        ...
        <div style={{ marginTop: "3vw" }}>
          <div style={{ marginLeft: "10vw", float: "left" }}>
            <a style={{ textDecoration: "none" }} href="#" className="button">
              <h1 className="font2">Our Project</h1>
            </a>
          </div>
          <div style={{ marginLeft: "20vw" }}>
            ...
            >
              <h1 className="font2 font3">Contact us</h1>
            </a>
          </div>
        </div>
      </div>
